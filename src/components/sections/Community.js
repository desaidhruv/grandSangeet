...
function Community() {
  ...
  return (
    <>
      ...
      <Modal size="5xl" onClose={onClose2} isOpen={isOpen2} w="100%" h="100%">
        <ModalOverlay />
        <ModalContent mt="200px" fontFamily="Poppins" borderRadius="20px" bg="#FFECF1">
          <ModalBody>
            <Icon
              fontSize="40px"
              color="#F178B6"
            ...
            />
            <VStack pt="20px" direction={['column', 'row']} as={Center}>
              <svg
                width="44"
                height="41"
                viewBox="0 0 44 41"
            ...
            <Center fontSize="25px" h="150px">
              <Text color="#00C11F" textAlign="center">Thanks for Joining! </Text><br></br>
