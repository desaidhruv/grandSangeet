...
function About() {
    return (
        <VStack
            ...
            h="800px"
        >
            <Text fontSize="48px" fontWeight="medium">About Us</Text>
            <HStack>
                <svg
                    width="44"
                    height="40"
                ...
                <Text fontSize="36px" color="#FF3B63">Grand Sangeet</Text>
            </HStack>
            <Text textAlign="center" h="100px" w="600px">
                Blazing fast web hosting for individuals and businesses of all sizes backed
